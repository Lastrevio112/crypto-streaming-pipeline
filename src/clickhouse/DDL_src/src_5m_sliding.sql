CREATE TABLE IF NOT EXISTS kafka_derived_ohlcv_5m_sliding
(
...
SETTINGS
    ...
    kafka_group_name                = 'clickhouse_ohlcv_5m_sliding_v3',
...
CREATE TABLE IF NOT EXISTS src_5m_sliding
(
    coin_symbol                 LowCardinality(String),
    window_start                DateTime64(3) CODEC(Delta(8), ZSTD(2)),
    window_end                  DateTime64(3) CODEC(Delta(8), ZSTD(2)),
...
CREATE MATERIALIZED VIEW mv_src_5m_sliding
TO src_5m_sliding
AS
SELECT
    coin_symbol,
